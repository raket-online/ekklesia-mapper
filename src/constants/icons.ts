/**
 * Icon definitions for Ekklesia Mapper
 * Each icon has an id and SVG path data
 */
...
export const availableIcons: Icon[] = [
  ...
  },
  {
    id: 'bread',
    name: 'Bread',
    path: 'M13.188 4.683c-.723-.723-.815-1.012.594-1.528c3.933-1.44 8.42 2.84 7.39 6.9c-.598 2.357-2.214 4.812-4.208 6.889c-2.077 1.994-4.532 3.61-6.89 4.209c-4.06 1.03-8.34-3.458-6.899-7.39c.516-1.41.805-1.318 1.527-.595c-2.278-2.278 1.624-6.862 3.776-4.71c-2.152-2.152 2.431-6.054 4.71-3.775m0 0l3.068 3.069m-3.068-3.07c-.723-.722-.815-1.01.593-1.527c3.934-1.44 8.422 2.84 7.391 6.9c-.598 2.357-2.214 4.812-4.209 6.889c-2.076 1.994-4.531 3.61-6.889 4.209c-4.06 1.03-8.34-3.458-6.899-7.391c.516-1.408.804-1.317 1.527-.594m8.486-8.485c-2.28-2.279-6.862 1.623-4.71 3.776m0 0l3.536 3.535M8.478 8.46c-2.152-2.153-6.054 2.43-3.776 4.709m0 0l3.07 3.069'
  },
  {
    id: 'seed',
    name: 'Seed',
    path: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253M12 3v1'
  },
  {
    id: 'money',
    name: 'Money',
  ...
  },
  {
    id: 'worship',
    name: 'Worship',
    path: 'M10 2a2 2 0 1 1-3.999.001A2 2 0 0 1 10 2M6 16h1.5v-5h1v5H10V7l-.001-.052c0-.521.194-.997.513-1.36L13.79 2.27a.73.73 0 1 0-.998-1.003L10.43 3.65c-.212.216-.508.35-.835.35H6.404c-.327 0-.622-.134-.834-.35L3.25 1.26a.73.73 0 1 0-1.003.998L5.49 5.59c.317.361.511.836.511 1.358L6 7.003z'
  },
  {
    id: 'fellowship',
    name: 'Fellowship',
    path: 'M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm-5.5 2c-3.03 0-5.5 2.47-5.5 5.5V22h11v-2.5c0-3.03-2.47-5.5-5.5-5.5zm11 0c-3.03 0-5.5 2.47-5.5 5.5V22h11v-2.5c0-3.03-2.47-5.5-5.5-5.5z'
  },
  {
    id: 'tag',
    name: 'Outreach',
    path: 'M10 14L21 3m0 0l-6.5 18a.55.55 0 0 1-1 0L10 14l-7-3.5a.55.55 0 0 1 0-1z'
  }
]

/**
 * Get icon path by icon ID
 * @param iconId - The ID of the icon
 * @returns The SVG path data for the icon
 */
